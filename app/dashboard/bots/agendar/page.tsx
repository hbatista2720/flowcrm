...
export default function AgendarBot() {
    ...
    <div className="h-screen flex flex-col">
      <header className="bg-white border-b px-6 py-4 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-xl font-semibold">Chatbot de Agendar</h1>
        </div>
        ...
        <div className="flex-1 p-6">
          {activeTab === 'editor' && (
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-lg font-semibold mb-4">Bot de Agendamiento</h2>
              <p className="text-gray-600 mb-4">Bot especializado en agendar citas y encuestas</p>
            </div>
          )}
